...
<body>
    ...
    <div class="container" style="margin-top:50px; margin-bottom: 20px;">
        <div class="col-sm-12" style="text-align:center;">
            <img id="logo" src="/static/images/uiaLogo.png" alt="" width="150px;" style="margin-top:40px;">
            <h2 style="font-weight: bold; margin-top: 10px;">Grade Target Universiti Islam Antarabangsa</h2>
        </div>
        <div class="row">
