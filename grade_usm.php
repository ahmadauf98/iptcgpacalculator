...
<body>
    ...
    <div class="container" style="margin-top:50px; margin-bottom: 20px;">
        <div class="col-sm-12" style="text-align:center;">
            <img id="logo" src="/static/images/usmLogo.png" alt="" width="150px;" style="margin-top:40px;">
            <h2 style="font-weight: bold; margin-top: 10px;">Grade Target Universiti Sains Malaysia</h2>
        </div>
        <div class="row">
                            ...
                            <div class="row" id="space">
                                <div class="col-sm-12" id="formspace">
                                    ...
                                    <select class="browser-default custom-select input5" name="tg1">
                                        ...
                                        <option value="70" <?php if (isset($tg1) && $tg1=="70") echo "checked";?>>A-
                                        </option>
                                        <option value="64" <?php if (isset($tg1) && $tg1=="64") echo "checked";?>>B+
                                        </option>
                                        <option value="58" <?php if (isset($tg1) && $tg1=="58") echo "checked";?>>B
                                        </option>
                                        <option value="52" <?php if (isset($tg1) && $tg1=="52") echo "checked";?>>B-
                                        </option>
                                        <option value="46" <?php if (isset($tg1) && $tg1=="46") echo "checked";?>>C+
                                        </option>
                                        <option value="40" <?php if (isset($tg1) && $tg1=="40") echo "checked";?>>C
                                        </option>
                                    </select>
                                </div>
                            </div>
