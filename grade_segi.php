...
<body>
    ...
    <div class="container" style="margin-top:50px; margin-bottom: 20px;">
        <div class="col-sm-12" style="text-align:center;">
            <img id="logo" src="/static/images/segiLogo.png" alt="" width="150px;" style="margin-top:40px;">
            <h2 style="font-weight: bold; margin-top: 10px;">Grade Target SEGI University</h2>
        </div>
        <div class="row">
        ...
        <div class="col-sm-13" style="margin-top: 30px;">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <!-- Title -->
                    <h4 class="card-title" style="text-align: center;">This grade conversion table is used at SEGI University</h4>
