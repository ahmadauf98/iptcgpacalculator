...
<head>
    ...
    <title>CGPA CALCULATOR TAYLOR'S</title>
...
<body>
    ...
    <div class="container" style="margin-top:50px; margin-bottom: 20px;">
        <div class="col-sm-12" style="text-align:center;">
            <img id="logo" src="/static/images/taylorLogo.png" alt="" width="250px;" style="margin-top:40px;">
            <h2 style="font-weight: bold; margin-top: 10px;">CGPA Calculator Taylor's University</h2>
        </div>
        <div class="row">
                            ...
                            <div class="row" id="space">
                                <div class="col-sm-3" id="formspace">
                                    ...
                                    <select class="browser-default custom-select dropdown1" name="grade1"
                                        ...
                                        <option value="0.67"
                                            <?php if (isset($grade) && $grade=="0.67") echo "checked";?>>D-</option>
                                        <option value="0.00"
        ...
        <div class="col-sm-13" style="margin-top: 30px;">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <!-- Title -->
                    <h4 class="card-title" style="text-align: center;">This grade conversion table is used at Taylor's
                        University</h4>
