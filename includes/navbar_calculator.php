<nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background:#1B1C1E;">
    <div class="container">
        <a class="navbar-brand" href="#">
            <img src="/static/images/Logo.png" width="auto" height="30" alt="">
        </a>
