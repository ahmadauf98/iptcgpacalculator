...
<head>
    ...
    <title>CGPA CALCULATOR UNIMAS</title>
...
<body>
    ...
    <div class="container" style="margin-top:50px; margin-bottom: 20px;">
        <div class="col-sm-12" style="text-align:center;">
            <img id="logo" src="/static/images/unimasLogo.png" alt="" width="150px;" style="margin-top:40px;">
            <h2 style="font-weight: bold; margin-top: 10px;">CGPA Calculator Universiti Malaysia Sarawak</h2>
        </div>
        <div class="row">
                            ...
                            <div class="row" id="space">
                                <div class="col-sm-3" id="formspace">
                                    ...
                                    <select class="browser-default custom-select dropdown1" name="grade1"
                                        ...
                                        <option value="1.50"
                                            <?php if (isset($grade) && $grade=="1.50") echo "checked";?>>C-</option>
                                        <option value="1.00"
