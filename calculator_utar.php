...
<head>
    ...
    <title>CGPA CALCULATOR UTAR</title>
...
<body>
    ...
    <div class="container" style="margin-top:50px; margin-bottom: 20px;">
        <div class="col-sm-12" style="text-align:center;">
            <img id="logo" src="/static/images/utarLogo.png" alt="" width="250px;" style="margin-top:40px;">
            <h2 style="font-weight: bold; margin-top: 10px;">CGPA Calculator Universiti Tunku Abdul Rahman</h2>
        </div>
        <div class="row">
