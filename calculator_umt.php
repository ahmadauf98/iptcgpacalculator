...
<body>
    ...
    <div class="container" style="margin-top:50px; margin-bottom: 20px;">
        <div class="col-sm-12" style="text-align:center;">
            <img id="logo" src="/static/images/umtLogo.png" alt="" width="200px;" style="margin-top:40px;">
            <h2 style="font-weight: bold; margin-top: 10px;">CGPA Calculator Universiti Malaysia Terengganu</h2>
        </div>
        <div class="row">
                            ...
                            <div class="row" id="space">
                                <div class="col-sm-3" id="formspace">
                                    ...
                                    <select class="browser-default custom-select dropdown1" name="grade1"
                                        ...
                                        <option value="3.75"
                                            <?php if (isset($grade) && $grade=="3.75") echo "checked";?>>A-</option>
                                        <option value="3.50"
                                            <?php if (isset($grade) && $grade=="3.50") echo "checked";?>>B+</option>
                                        <option value="3.00"
                                            <?php if (isset($grade) && $grade=="3.00") echo "checked";?>>B</option>
                                        <option value="2.75"
                                            <?php if (isset($grade) && $grade=="2.75") echo "checked";?>>B-</option>
                                        <option value="2.50"
                                            <?php if (isset($grade) && $grade=="2.50") echo "checked";?>>C+</option>
                                        <option value="2.00"
                                            <?php if (isset($grade) && $grade=="2.00") echo "checked";?>>C</option>
                                        <option value="1.75"
                                            <?php if (isset($grade) && $grade=="1.75") echo "checked";?>>C-</option>
                                        <option value="1.00"
