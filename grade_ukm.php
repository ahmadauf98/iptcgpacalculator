...
<body>
    ...
    <div class="container" style="margin-top:50px; margin-bottom: 20px;">
        <div class="col-sm-12" style="text-align:center;">
            <img id="logo" src="/static/images/ukmLogo.png" alt="" width="150px;" style="margin-top:40px;">
            <h2 style="font-weight: bold; margin-top: 10px;">Grade Target Universiti Kebangsaan Malaysia</h2>
        </div>
        <div class="row">
                            ...
                            <div class="row" id="space">
                                <div class="col-sm-12" id="formspace">
                                    ...
                                    <select class="browser-default custom-select input5" name="tg1">
                                        ...
                                        <option value="85" <?php if (isset($tg1) && $tg1=="85") echo "checked";?>>A
                                        </option>
                                        ...
                                        <option value="55" <?php if (isset($tg1) && $tg1=="55") echo "checked";?>>B-
                                        </option>
                                        <option value="50" <?php if (isset($tg1) && $tg1=="50") echo "checked";?>>C+
                                        </option>
                                        <option value="45" <?php if (isset($tg1) && $tg1=="45") echo "checked";?>>C
                                        </option>
                                    </select>
                                </div>
                            </div>
