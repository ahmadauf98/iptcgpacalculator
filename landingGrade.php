...
<body>
    ...
    <footer class="page-footer font-small grey darken-4 pt-4">
        ...
        <!-- Copyright -->
        <div class="footer-copyright text-center py-3">&#9400; All rights reserved 2019 by
            <a href="#">AA DEV</a>
        </div>
        <!-- Copyright -->
