...
<head>
    ...
    <title>CGPA CALCULATOR UMS</title>
...
<body>
    ...
    <div class="container" style="margin-top:50px; margin-bottom: 20px;">
        <div class="col-sm-12" style="text-align:center;">
            <img id="logo" src="/static/images/umsLogo.png" alt="" width="150px;" style="margin-top:40px;">
            <h2 style="font-weight: bold; margin-top: 10px;">CGPA Calculator Universiti Malaysia Sabah</h2>
        </div>
        <div class="row">
                            ...
                            <div class="row" id="space">
                                <div class="col-sm-3" id="formspace">
                                    ...
                                    <select class="browser-default custom-select dropdown1" name="grade1"
                                        ...
                                        <option value="3.67"
                                            <?php if (isset($grade) && $grade=="3.67") echo "checked";?>>A-</option>
                                        <option value="3.33"
                                            <?php if (isset($grade) && $grade=="3.33") echo "checked";?>>B+</option>
                                        <option value="3.00"
                                            <?php if (isset($grade) && $grade=="3.00") echo "checked";?>>B</option>
                                        <option value="2.67"
                                            <?php if (isset($grade) && $grade=="2.67") echo "checked";?>>B-</option>
                                        <option value="2.33"
                                            <?php if (isset($grade) && $grade=="2.33") echo "checked";?>>C+</option>
                                        <option value="2.00"
                                            <?php if (isset($grade) && $grade=="2.00") echo "checked";?>>C</option>
                                        <option value="1.67"
                                            <?php if (isset($grade) && $grade=="1.67") echo "checked";?>>C-</option>
                                        <option value="1.33"
                                            <?php if (isset($grade) && $grade=="1.33") echo "checked";?>>D+</option>
                                        <option value="1.00"
                                            <?php if (isset($grade) && $grade=="1.00") echo "checked";?>>D</option>
                                        <option value="0.00"
                                            <?php if (isset($grade) && $grade=="0.00") echo "checked";?>>E</option>
                                    </select>
                                </div>
                                <div class="col-sm-3" id="formspace">
                                    <!-- Points Input -->
                    ...
                    <table class="table table-bordered" style="text-align: center;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="Grade Points">3.40</td>
                            </tr>
                            <tr>
                                <td data-label="Letter">B</td>
                            ...
                            <tr>
                                ...
                                <td data-label="Grade Points">2.40</td>
                            </tr>
                            <tr>
                                <td data-label="Letter">C</td>
                            ...
                            <tr>
                                ...
                                <td data-label="Grade Points">1.40</td>
                            </tr>
                            <tr>
                                <td data-label="Letter">D</td>
