...
<body>
    ...
    <!-- Slideshow Section -->
    <div class="uk-position-relative uk-visible-toggle uk-light" tabindex="-1" uk-slideshow="animation: fade; autoplay: true; autoplay-interval: 4000; min-height: 600; max-height: 600" id="home" style="margin-top:50px;">
