...
<head>
    ...
    <title>CGPA CALCULATOR UPSI</title>
...
<body>
    ...
    <div class="container" style="margin-top:50px; margin-bottom: 20px;">
        <div class="col-sm-12" style="text-align:center;">
            <img id="logo" src="/static/images/upsiLogo.png" alt="" width="250px;" style="margin-top:40px;">
            <h2 style="font-weight: bold; margin-top: 10px;">CGPA Calculator Universiti Pendidikan Sultan Idris</h2>
        </div>
        <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h4 class="card-title" style="text-align: center;">This grade conversion table is used at Universiti
                        Pendidikan Sultan Idris (UPSI)</h4>
